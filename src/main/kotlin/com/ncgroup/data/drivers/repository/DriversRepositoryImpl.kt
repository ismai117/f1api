...
class DriversRepositoryImpl : DriversRepository {
...
private val drivers = listOf(
    Driver(
        ...
        headshotImageUrl = "$BASE_URL/headshots/1.png",
        profileImageUrl = "$BASE_URL/profileImages/1.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/1.png",
        countryImageUrl = "$BASE_URL/flags/ned.png",
        biography =  """
    ...
    Driver(
        ...
        teamColour = "64C4FF",
        teamName = "Williams",
        headshotImageUrl = "$BASE_URL/headshots/2.png",
        profileImageUrl = "$BASE_URL/profileImages/2.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/2.png",
        countryImageUrl = "$BASE_URL/flags/usa.png",
        biography = """
            Logan Sargeant became F1’s first American driver in almost eight years as he took to the grid for the 2023 season, giving the country a home favourite to cheer once more.
            ...
            Not since Alexander Rossi’s quintet of appearances with backmarkers Manor at the tail-end of the 2015 season had an American graced the F1 grid, and Sargeant relished changing that across his first season, even if on paper a solitary point was his only reward.

            And with three races in the US now on the Formula 1 calendar – Miami, Austin and Las Vegas – America’s latest F1 star knows he will be spurred on by plenty of home support.
        """.trimIndent()
    ),
    Driver(
        ...
        teamColour = "FF8000",
        teamName = "McLaren",
        headshotImageUrl = "$BASE_URL/headshots/4.png",
        profileImageUrl = "$BASE_URL/profileImages/4.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/4.png",
        countryImageUrl = "$BASE_URL/flags/gbr.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "FF87BC",
        teamName = "Alpine",
        headshotImageUrl = "$BASE_URL/headshots/10.png",
        profileImageUrl = "$BASE_URL/profileImages/10.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/10.png",
        countryImageUrl = "$BASE_URL/flags/fra.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "3671C6",
        teamName = "Red Bull Racing",
        headshotImageUrl = "$BASE_URL/headshots/11.png",
        profileImageUrl = "$BASE_URL/profileImages/11.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/11.png",
        countryImageUrl = "$BASE_URL/flags/mex.png",
        biography = """
    ...
    Driver(
        ...
        headshotImageUrl = "$BASE_URL/headshots/14.png",
        profileImageUrl = "$BASE_URL/profileImages/14.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/14.png",
        countryImageUrl = "$BASE_URL/flags/esp.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "E8002D",
        teamName = "Ferrari",
        headshotImageUrl = "$BASE_URL/headshots/16.png",
        profileImageUrl = "$BASE_URL/profileImages/16.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/16.png",
        countryImageUrl = "$BASE_URL/flags/mon.png",
        biography = """
    ...
    Driver(
        ...
        headshotImageUrl = "$BASE_URL/headshots/20.png",
        profileImageUrl = "$BASE_URL/profileImages/20.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/20.png",
        countryImageUrl = "$BASE_URL/flags/den.png",
        biography = """
            Call him a lone ranger or a maverick, but Magnussen is in Formula 1 for one reason only – to race.
    ...
    Driver(
        ...
        teamColour = "6692FF",
        teamName = "RB",
        headshotImageUrl = "$BASE_URL/headshots/22.png",
        profileImageUrl = "$BASE_URL/profileImages/22.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/22.png",
        countryImageUrl = "$BASE_URL/flags/jpn.png",
        biography = """
    ...
    Driver(
        ...
        headshotImageUrl = "$BASE_URL/headshots/24.png",
        profileImageUrl = "$BASE_URL/profileImages/24.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/24.png",
        countryImageUrl = "$BASE_URL/flags/chn.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "B6BABD",
        teamName = "Haas F1 Team",
        headshotImageUrl = "$BASE_URL/headshots/27.png",
        profileImageUrl = "$BASE_URL/profileImages/27.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/27.png",
        countryImageUrl = "$BASE_URL/flags/ger.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "FF87BC",
        teamName = "Alpine",
        headshotImageUrl = "$BASE_URL/headshots/31.png",
        profileImageUrl = "$BASE_URL/profileImages/31.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/31.png",
        countryImageUrl = "$BASE_URL/flags/fra.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "27F4D2",
        teamName = "Mercedes",
        headshotImageUrl = "$BASE_URL/headshots/44.png",
        profileImageUrl = "$BASE_URL/profileImages/44.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/44.png",
        countryImageUrl = "$BASE_URL/flags/gbr.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "E8002D",
        teamName = "Ferrari",
        headshotImageUrl = "$BASE_URL/headshots/55.png",
        profileImageUrl = "$BASE_URL/profileImages/55.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/55.png",
        countryImageUrl = "$BASE_URL/flags/esp.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "27F4D2",
        teamName = "Mercedes",
        headshotImageUrl = "$BASE_URL/headshots/63.png",
        profileImageUrl = "$BASE_URL/profileImages/63.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/63.png",
        countryImageUrl = "$BASE_URL/flags/gbr.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "FF8000",
        teamName = "McLaren",
        headshotImageUrl = "$BASE_URL/headshots/81.png",
        profileImageUrl = "$BASE_URL/profileImages/81.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/81.png",
        countryImageUrl = "$BASE_URL/flags/aus.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "64C4FF",
        teamName = "Williams",
        headshotImageUrl = "$BASE_URL/headshots/23.png",
        profileImageUrl = "$BASE_URL/profileImages/23.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/23.png",
        countryImageUrl = "$BASE_URL/flags/tha.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "52E252",
        teamName = "Kick Sauber",
        headshotImageUrl = "$BASE_URL/headshots/77.png",
        profileImageUrl = "$BASE_URL/profileImages/77.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/77.png",
        countryImageUrl = "$BASE_URL/flags/fin.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "229971",
        teamName = "Aston Martin",
        headshotImageUrl = "$BASE_URL/headshots/18.png",
        profileImageUrl = "$BASE_URL/profileImages/18.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/18.png",
        countryImageUrl = "$BASE_URL/flags/can.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "6692FF",
        teamName = "RB",
        headshotImageUrl = "$BASE_URL/headshots/3.png",
        profileImageUrl = "$BASE_URL/profileImages/3.png",
        driverNumberImage = "$BASE_URL/driverNumberLogo/3.png",
        countryImageUrl = "$BASE_URL/flags/aus.png",
        biography = """
    ...
    Driver(
        ...
        teamColour = "E8002D",
        teamName = "Ferrari",
        headshotImageUrl = "$BASE_URL/headshots/38.png",
        profileImageUrl = "",
        driverNumberImage = "$BASE_URL/driverNumberLogo/38.png",
        countryImageUrl = "$BASE_URL/flags/gbr.png",
        biography = """
